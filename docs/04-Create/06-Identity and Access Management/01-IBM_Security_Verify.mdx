...
sidebar_position: 1
description: Integrating IBM Security Verify into Watsonx Assistant
...
:::warning
    Prerequisite: [IBM Security Verify Software Requirement](/Prepare/Requirements#user-authentication)
:::
