---
title: RAG Source Links
sidebar_position: 2
description: How to setup document source links for RAG
...
This section will go over how to add source links for files within an Assistant. Though there are different methods in which source links can be created, this 
document will cover these methods:
